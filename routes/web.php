...
Route::get('/', function () {
    ...
    return view('home', compact('header_menu', 'comics', 'footer_socials', 'footer_navs')); //? oppure ['comics' => $comics]
})->name('home');
...
Route::get('/comic', function () {
    ...
    return view('comic', compact('header_menu', 'comics', 'footer_socials', 'footer_navs')); //? oppure ['comics' => $comics]
})->name('comic');
